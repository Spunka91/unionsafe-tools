...
function handleContactSubmit() {
  ...
  saveSubmission(r);
  show('contactOutput', 'Thank you. Your information was submitted to UnionSafe141. A private local record was saved on this browser for admin export if opened in admin view.');
