...
function handleContactSubmit() {
  ...
  show('contactOutput', 'Thank you. Your information has been submitted to UnionSafe141. Your contact information is not displayed on this public tool.');
...
document.addEventListener('DOMContentLoaded', () => {
  if (new URLSearchParams(window.location.search).get('submitted') === 'true') {
    show('contactOutput', 'Thank you. Your submission was received by the UnionSafe141 form system.');
  }
});
