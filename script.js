...
function gsapWording(){
  ...
  if(has(t,["tug","tractor","aircraft","hit","contact","collision","damage","tail","nose","towbar"])){ 
    ...
    specific.push("names/titles of managers or leads notified, time notification was made, and whether the scene/equipment was preserved");
  }
  ...
  if(has(t,["staff","short","coverage","alone","manpower","rushed","pressure","time","multiple","overlap"])){ 
    specific.push("staffing level, assignments, task overlap, time pressure, and whether the crew had enough people/resources to complete required steps safely");
  }
